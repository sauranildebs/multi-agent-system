...
def get_position(msg):
    global lat, lon , ini_lat , ini_lon, flag21 ;
    lat = msg.latitude
    lon = msg.longitude
...
def main():
    ...
    r1flag = rospy.Publisher('/rover1/flag',Bool,queue_size = 10)
    #global N
    #N = 100
    ...
    while not rospy.is_shutdown():    
        #FROM Sini_shep[0][0] + 5*ITL WITH PATIENCE :P
        Sh[0,0] = ini_shep[0][0] + 3*local_lat1 
        Sh[0,1] = ini_shep[0][1] + 3*local_lon1
        Sh[1,0] = ini_shep[1][0] + 3*local_lat2 
        Sh[1,1] = ini_shep[1][1] + 3*local_lon2 
